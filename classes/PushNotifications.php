    ...
    public function initialize(array $config): void
    {
        ...
        $app->routes
            ...
            ->add('/ivopetkov-push-notifications-service-worker.js', function () use ($app) {
                $jsCode = file_get_contents(__DIR__ . '/../assets/serviceWorker.min.js');
                $jsCode = str_replace('URL_TO_REPLACE', $app->urls->get('/ivopetkov-push-notifications-data'), $jsCode);
                $response = new App\Response($jsCode);
